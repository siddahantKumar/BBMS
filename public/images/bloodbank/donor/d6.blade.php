...
<!-- Mirrored from demosly.com/xicia/bloodbank/donor/6 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 17:29:21 GMT -->
			...
			<div class="col-md-4 col-sm-4">
				<div class="donner-leftbar">
					<div class="donner-profile-item">
						<div class="donner-image" style="background-image: url(../assets/uploads/donors/6.jpg)"></div>
				...
				<div class="donner-description">
					<div class="donner-description-list">
						...
						<table class="table table-bordered">
							...
							<tr>
								<td>Email: </td>
								<td>JamesBDay@jourrapide.com</td>
							</tr>
							<tr>
								<td>Phone: </td>
								<td>361-673-0025</td>
