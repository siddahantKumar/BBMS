...
<!-- Mirrored from demosly.com/xicia/bloodbank/donor/5 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 17:29:21 GMT -->
			...
			<div class="col-md-4 col-sm-4">
				<div class="donner-leftbar">
					<div class="donner-profile-item">
						<div class="donner-image" style="background-image: url(../assets/uploads/donors/5.jpg)"></div>
						<div class="donner-leftbar-info">
							<h2>Kenneth C. Beck</h2>
				...
				<div class="donner-description">
					<div class="donner-description-list">
						...
						<table class="table table-bordered">
							...
							<tr>
								<td>Email: </td>
								<td>KennethCBeck@teleworm.us</td>
							</tr>
							<tr>
								<td>Phone: </td>
								<td>517-607-5811</td>
