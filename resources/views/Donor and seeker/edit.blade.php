...
<form class="text-center border border-light p-5" action="{{ route('update',$seeker->id) }}" method="POST">
    {{ csrf_field()}}

    <div  class="Box">
	<h1>Register Your Account</h1>
    <p>Create an account to register in our site.</p><br>
    <!-- so here we get an information of particular id -->
	<i class="fa fa-user fa-2x cust"></i>
	<input type="text" id="username" placeholder="User Name" value ="{{$seeker->user_name}}" name="user_name" ><br>
	<i class="fa fa-lock fa-2x cust"></i>
	<input type="text" id="address" placeholder="Address" value ="{{$seeker->address}}" name="address" ><br>
	<i class="fa fa-lock fa-2x cust"></i>
	<input type="text" id="number" placeholder="Mobile Number" value ="{{$seeker->phone}}" name="phone" ><br>
	<i class="fa fa-envelope fa-2x cust1"></i>
	<input type="text" id="email" placeholder="Email" value ="{{$seeker->email}}" name="email" ><br>
	<i class="fa fa-lock fa-2x cust"></i>
