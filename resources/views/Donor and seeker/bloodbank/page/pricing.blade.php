...
<head>
	...
	<meta name="description" content=""><meta name="keywords" content=""><title>Pricing - Blood Bank</title>
	<!-- Favicon -->
	<!-- Favicon -->
...
<!--Banner Start-->
<div class="banner-slider" style="background-image: url(public/images/bloodbank/assets/uploads/page-banner-15.jpg)">
	<div class="bg"></div>
		...
		<div class="row">
					...
					<div class="packages-item">
						<div class="pack-head">
							<h3>Basic</h3>
							<h2>$10</h2>
							<h4 class="first">Active Days: 10</h4>
							<h4>Number of Items Allowed: 20</h4>
						</div>
						<div class="pack-body">
...
<p>Lorem ipsum dolor sit amet</p>-->
					...
					<div class="packages-item">
						<div class="pack-head">
							<h3>Gold</h3>
							<h2>$20</h2>
							<h4 class="first">Active Days: 20</h4>
							<h4>Number of Items Allowed: 40</h4>
						</div>
						<div class="pack-body">
							<!--<p>Lorem ipsum dolor sit amet</p>
...
<p>Lorem ipsum dolor sit amet</p>-->
					...
					<div class="packages-item">
						<div class="pack-head">
							<h3>Platinum</h3>
							<h2>$30</h2>
							<h4 class="first">Active Days: 30</h4>
							<h4>Number of Items Allowed: 60</h4>
						</div>
						<div class="pack-body">
							<!--<p>Lorem ipsum dolor sit amet</p>
