...
<head>
	...
	<meta name="description" content=""><meta name="keywords" content=""><title>Blog - Blood Bank</title>
	<!-- Favicon -->
...
<!--Banner Start-->
<div class="banner-slider" style="background-image: url(public/images/bloodbank/assets/uploads/page-banner-9.jpg)">
	<div class="bg"></div>
	...
	<div class="container">
		<div class="row">
					...
					<div class="latest-item">
						<div class="latest-photo" style="background-image: url(public/images/bloodbank/assets/uploads/news-1.jpg)"></div>
						<div class="latest-text">
							...
							<div class="latest-pra">
								...
								<div class="col-md-4 col-sm-6 col-xs-12 blog-item">
					<div class="latest-item">
						<div class="latest-photo" style="background-image: url(public/images/bloodbank/assets/uploads/news-2.jpg)"></div>
						<div class="latest-text">
							<h2><a href="https://www.aa.com.tr/en/asia-pacific/pakistan-covid-19-patient-recovers-with-plasma-therapy/1835196">COVID 19 through Plasma </a></h2>
							<ul>
								<li>Category: <a href="../category/economy.html">Economy</a></li>
								<li>Date: 05-09-2017</li>
							</ul>
							<div class="latest-pra">
								...
								<div class="col-md-4 col-sm-6 col-xs-12 blog-item">
					<div class="latest-item">
						<div class="latest-photo" style="background-image: url(public/images/bloodbank/assets/uploads/news-3.jpg)"></div>
						<div class="latest-text">
							...
							<div class="latest-pra">
								...
								<div class="col-md-4 col-sm-6 col-xs-12 blog-item">
					<div class="latest-item">
						<div class="latest-photo" style="background-image: url(public/images/bloodbank/assets/uploads/news-4.jpg)"></div>
						<div class="latest-text">
