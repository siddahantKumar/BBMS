...
<head>
	...
	<meta name="description" content=""><meta name="keywords" content=""><title>Contact Us  - Blood Bank</title>
	<!-- Favicon -->
	<!-- Favicon -->
...
<!--Banner Start-->
<div class="banner-slider" style="background-image: url(public/images/bloodbank/assets/uploads/page-banner-2.jpg)">
	<div class="bg"></div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="contact-form">
					<form accept="https://demosly.com/xicia/bloodbank/page/contact-us" method="post">
						<div class="form-row">
