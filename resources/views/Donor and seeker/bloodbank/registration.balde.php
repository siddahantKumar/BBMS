...
<div class="banner-slider" style="background-image: url(assets/uploads/banner_registration.jpg)">
	<div class="bg"></div>
	...
	<div class="container">
		<div class="row">
					...
					<form action="#" method="post">
						...
						<div class="form-row">
							...
							<div class="form-group  col-md-6">
								...
								<input type="text" class="form-control" name="agent_name" placeholder="Full Name" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">Designation *</label>
								<input type="text" class="form-control" name="agent_designation" placeholder="Designation" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">Organization *</label>
								<input type="text" class="form-control" name="agent_organization" placeholder="Organization" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">Email Address *</label>
								<input type="email" class="form-control" name="agent_email" placeholder="Email Address" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">Phone *</label>
								<input type="text" class="form-control" name="agent_phone" placeholder="Phone Number" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">Address *</label>
								<input type="text" class="form-control" name="agent_address" placeholder="Address" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">Country *</label>
								<input type="text" class="form-control" name="agent_country" placeholder="Country" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">State</label>
								<input type="text" class="form-control" name="agent_state" placeholder="State" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">City *</label>
								<input type="text" class="form-control" name="agent_city" placeholder="City" value="">
							</div>

							<div class="form-group  col-md-6">
								<label for="">Zip Code *</label>
								<input type="text" class="form-control" name="agent_zip_code" placeholder="Zip Code" value="">
							</div>							
			...
			<div class="login-here">
				<h3><i class="fa fa-user-circle-o"></i> Already a Member? <a href="login.html">Login Here</a></h3>
			</div>			
