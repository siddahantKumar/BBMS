...
<!-- Mirrored from demosly.com/xicia/bloodbank/agent/12 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 17:29:22 GMT -->
			...
			<div class="col-md-4 col-sm-4">
				<div class="agent-leftbar">
					<div class="agent-profile-item">
													<div class="agent-image" style="background-image: url(../assets/uploads/agents/12.jpg)"></div>
												
						<div class="agent-leftbar-info">
							<h2>James V. Green</h2>
							<ul>
								<li>Designation: <span>Mail Process Operator</span></li>
								<li>Organization: <span>The Fox and Hound</span></li>
							</ul>
				...
				<div class="agent-description">
					...
					<div class="agent-description-list">
						<table class="table table-bordered">
							...
							<tr>
								<td>Address: </td>
								<td>1910 Saint James Drive, PA 17019</td>
							</tr>
							<tr>
								<td>Country: </td>
								<td>USA</td>
