...
<!-- Mirrored from demosly.com/xicia/bloodbank/agent/10 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 17:29:22 GMT -->
...
<div class="banner-slider" style="background-image: url(../assets/uploads/banner_agent.jpg)">
	<div class="bg"></div>
			...
			<div class="col-md-4 col-sm-4">
				<div class="agent-leftbar">
					<div class="agent-profile-item">
													<div class="agent-image" style="background-image: url(../assets/uploads/agents/10.jpg)"></div>
												
						<div class="agent-leftbar-info">
							<h2>Charles Saddler</h2>
							<ul>
								<li>Designation: <span>Sales Officer</span></li>
								<li>Organization: <span>BB Hospital</span></li>
							</ul>
