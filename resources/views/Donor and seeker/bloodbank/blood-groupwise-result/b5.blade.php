...
<!-- Mirrored from demosly.com/xicia/bloodbank/blood-groupwise-result/5 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 17:29:20 GMT -->
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="top-header-right">
										...
										<option></option>
										<option value="{{ route('Reg')}}">Register As Donor</option>
																				<option></option>
										<option value="{{ route('Reg')}}">Register As Seeker</option>-->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="parent">					<div class="col-md-3 col-sm-4 col-xs-12 blood-list">
						<div class="donner-item">
							<div class="donner-list">
								<div class="donner-photo" style="background-image: url(public/images/bloodbank/assets/uploads/donors/2.jpg)"></div>
								<div class="donner-info">
									<h2><a href="#">Gary L. Vazquez</a></h2>
...
<!-- Mirrored from demosly.com/xicia/bloodbank/blood-groupwise-result/5 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 17:29:21 GMT -->
</html>