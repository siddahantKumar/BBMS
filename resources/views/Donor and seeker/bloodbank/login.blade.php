...
<div class="banner-slider" style="background-image: url(assets/uploads/banner_login.jpg)">
	<div class="bg"></div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="login-here">
				<h3><i class="fa fa-user-circle-o"></i> New User? <a href="registration.html">Register Here</a></h3>
				<h3 style="margin-top:15px;"><i class="fa fa-user-circle-o"></i> Forget Password? <a href="forget-password.html">Click Here</a></h3>
			</div>
...
<!-- Mirrored from demosly.com/xicia/bloodbank/login by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 17:29:11 GMT -->
</html>