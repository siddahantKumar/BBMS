...
<head>
      ...
      <!-- Start page Label Plugins 
         =====================================================================-->
      <!-- Emojionearea -->
      <link href="public/images/assets/plugins/emojionearea/emojionearea.min.css" rel="stylesheet" type="text/css"/>
      <!-- Monthly css -->
      <link href="public/images/assets/plugins/monthly/monthly.css" rel="stylesheet" type="text/css"/>
   ...
   <body class="hold-transition sidebar-mini">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>BloodBank Admin Dashboard</h1>
                  <small>Very detailed & featured admin for BBDMS</small>
               </div>
            </section>
            <!-- Main content -->
      ...
      <!-- Start Page Lavel Plugins
         =====================================================================-->
      <!-- ChartJs JavaScript -->
      <script src="public/images/assets/plugins/chartJs/Chart.min.js" type="text/javascript"></script>
      <!-- Counter js -->
      <script src="public/images/assets/plugins/counterup/waypoints.js" type="text/javascript"></script>
      <script src="public/images/assets/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
      <!-- Monthly js -->
      <script src="public/images/assets/plugins/monthly/monthly.js" type="text/javascript"></script>
