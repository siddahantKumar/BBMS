...
<body>
  ...
  @if (session('successMsg'))<!-- this is what if set alert if things not work show us --> 

<div class="alert alert-success" role="alert">
 
  {{ session('successMsg')}} <!-- show success msg if data inserted -->

</div>
   <div class="header">
      
   	  <h1 id="login">ADMIN <br>Login</h1>
      <h1>what us </h1>
   </div>
<!--    form-group
   form-control -->
